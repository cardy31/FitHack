...
urlpatterns = format_suffix_patterns([
    ...
    url(r'^food/(?P<pk>[0-9]+)/$',
        ...
        name='food-detail'),
    url(r'^historicweight/$',
        views.HistoricWeightList.as_view(),
        name='historicweight-list'),
    url(r'^historicweight/(?P<pk>[0-9]+)/$',
        views.HistoricWeightDetail.as_view(),
        name='historicweight-detail'),
    url(r'^memberinfo/$',
